...
void dae::TrashTheCache::RenderPlot(const std::vector<float>& samples, size_t verticalLineIndex, const ImColor& color)
{
...
void dae::TrashTheCache::RenderDoublePlot()
{
...
void dae::TrashTheCache::Excercise1()
{
    m_Ex1Samples.clear();
...
void dae::TrashTheCache::Excercise2()
{
    m_Ex2Samples.clear();
...
void dae::TrashTheCache::Excercise2alt()
{
