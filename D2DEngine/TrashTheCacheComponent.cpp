...
void D2D::TrashTheCacheComponent::OnGUI()
{
	RenderExercise1();
...
void D2D::TrashTheCacheComponent::RenderPlot(const std::vector<float>& samples, size_t verticalLineIndex, const ImColor& color)
{
...
void D2D::TrashTheCacheComponent::RenderDoublePlot()
{
...
void D2D::TrashTheCacheComponent::RenderExercise1()
{
...
void D2D::TrashTheCacheComponent::RenderExercise2()
{
    const ImGuiViewport* main_viewport = ImGui::GetMainViewport();
...
void D2D::TrashTheCacheComponent::Excercise1()
{
    m_Ex1Samples.clear();
...
void D2D::TrashTheCacheComponent::Excercise2()
{
    m_Ex2Samples.clear();
...
void D2D::TrashTheCacheComponent::Excercise2alt()
{
